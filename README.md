...
Prebuilt binaries are attached to each [GitHub Release](https://github.com/mangeshghodke/DreamPlayer/releases). The current release is **0.1.10**; previous releases follow the **0.1.x** and **0.0.x** lines.
